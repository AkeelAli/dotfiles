...
" akeali: turn off swp files
":set noswapfile


" akeali: jump to last position when file was closed
if has("autocmd")
...
" akeali: make all vim session share the same X selection buffer
set clipboard=unnamed

" akeali: add mouse support (in normal mode only, not while editing)
if has('mouse')
    :set mouse=n
endif

" akeali: underline row
set cursorline

" akeali: highlight in red excesses > 80 chars + trailing whitespace
match ErrorMsg '\%>80v.\+'
match ErrorMsg '\s\+$'
